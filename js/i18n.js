    ...
    getEmbeddedTranslations() {
        return {
            en: {
                ...
                "instructions.step1.desc": "If you trust this service, you can log in directly using your BIT SSO account and password. Or, you can first visit Yanhekt and log in to your account, then use our bookmark tool to extract your access token. This operation only needs to be done once while the token is valid.",
                ...
                "instructions.bookmark.note": "Note: This tool is more convenient to use on desktop browsers. On desktop browsers, press Ctrl/Cmd+Shift+B to show the bookmarks bar; on iOS Safari, tap the \"book\" icon at the bottom of the interface to enter the bookmarks bar, then long-press the button above and drag it here.",
                ...
                "instructions.step3.desc": "To view the courses you have registered for this semester, please check your personal live stream list; to view all live stream courses currently available across the school, please switch to the public live stream list. Select the course you want to watch.",
                ...
                "instructions.step5.desc": "Slides will be saved in your browser's local database. Click \"View Saved Slides\" to manage them. Tip: If downloading fails on the live page, you can return here to view and download all saved slides.",
            ...
            zh: {
                ...
                "instructions.step1.desc": "如果您信任本服务，您可以使用 BIT 统一身份认证（SSO）账户密码直接登录。或者，您也可以先在延河课堂网站登录，然后使用我们的书签工具提取访问密钥​。在密钥​有效期内，此操作只需执行一次。",
                "instructions.bookmark.title": "书签工具",
                "instructions.bookmark.instruction": "将下面的按钮拖拽到您的书签栏/收藏栏，然后在延河课堂网站上点击它：",
                "instructions.bookmark.button": "获取延河课堂密钥​",
                "instructions.bookmark.note": "提示：此工具在桌面浏览器上更方便使用。在桌面浏览器上，按下 Ctrl/Cmd+Shift+B 显示书签栏；在 iOS Safari 上，点击界面下方“书本”图标进入书签栏，长按上面的按钮把它拖拽到这里。",
                "instructions.step2.title": "输入您的密钥​",
                "instructions.step2.desc": "将从延河课堂复制的密钥​粘贴到下面的输入框中。我们不会在服务器上存储您的账户、密码和访问密钥​。",
                "instructions.step3.title": "观看直播课程",
                "instructions.step3.desc": "要查看您本学期注册的课程，请查看个人直播列表；要查看当前时段全校的直播课程，请切换到全校直播列表。选择您想要观看的课程。",
                ...
                "instructions.step5.desc": "幻灯片会保存在您浏览器的本地数据库中，点击“查看已储存幻灯片”可进行管理。​提示：若在直播页面下载失败，您可返回此处查看并下载所有已储存的幻灯片。​",
                ...
                "streams.title": "直播列表",
                "streams.personal": "个人直播",
                "streams.public": "全校直播",
                "streams.no_streams.title": "未找到直播",
